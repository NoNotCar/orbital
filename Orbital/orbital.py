...
levels=(([Asteroid],15,1),([Asteroid,BigAsteroid],20,1.5),([Hostage,Asteroid],30,1),([BigAsteroid,SmallAsteroid],30,2),([MustShoot],30,1),
([Asteroid,Obstacle],30,1),([Obstacle2],30,1),([EnemyShip],30,1),([Ranged],30,1),([Obstacle,MustShoot],30,1.5),([EnemyShip2],60,2))
level=0
